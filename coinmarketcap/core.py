...
class Market(object):
	...
	def qoutes_historical_v2(self, ticker: str, timestamp_start: int, timestamp_end: int, interval: str = '24h') -> List[TokenState]:
		...
		response = self.__request('v2/cryptocurrency/quotes/historical', params=params)
